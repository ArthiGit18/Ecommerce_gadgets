    ...
    return (
        <div className="bg-white border-t-4 border-indigo-900 shadow-md py-4 px-6 flex flex-wrap items-center justify-between text-sm font-semibold text-gray-800">
            <div className="flex items-center space-x-2">
                <img src="/icons/handshake.svg" alt="Handshake" className="w-6 h-6" />
                <div>
            ...
            <div className="flex items-center space-x-2">
                <img src="/icons/delivery.svg" alt="Delivery" className="w-6 h-6" />
                <div>
            ...
            <div className="flex items-center space-x-2">
                <img src="/icons/queen-award.svg" alt="Award" className="w-6 h-6" />
                <div>
            ...
            <div className="flex items-center space-x-2">
                <img src="/icons/iso.svg" alt="ISO" className="w-6 h-6" />
                <div>
